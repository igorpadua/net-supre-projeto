 ...
 */
class getPessoaControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\PessoaController' shared autowired service.
     *
     * @return \App\Controller\PessoaController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/PessoaController.php';

        $container->services['App\\Controller\\PessoaController'] = $instance = new \App\Controller\PessoaController();
        ...
        ]))->withContext('App\\Controller\\PessoaController', $container));
